...
class WorkflowRepository(BaseRepository):
    ...
    async def update_workflow_status(
        self, workflow_id: str, status: str, current_stage: str | None = None
    ) -> dict[str, Any]:
    ...
    async def get_active_workflow_for_program(self, program_id: str) -> dict[str, Any] | None:
    ...
    async def mark_workflow_failed(
        self, workflow_id: str, error_message: str | None = None
    ) -> dict[str, Any]:
